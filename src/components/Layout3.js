      ...
      <div className="layout-right">
          ...
          <div className="lvContainer lvpWelcome">
            <div className="lvTimeline-icon">
              <div className="lvImage">
                <img
                  className="lvImageIcon"
                  alt="PointWelcomeImage"
                  src={image2}
                />
              </div>
            </div>
        ...
        <div className="lvRocketBox">
          <img
            className="lvRocket"
            alt="Rocket"
            src="https://github.com/GraduateCampus/CanvasEditor/blob/main/src/components/images/Gif-Rakete.gif?raw=true"
          />
          <div className="lvRocketText">{rockettext}</div>
        </div>
        <ViewContact />
        <img
          className="learniacLogo"
          alt="LearniacLogo"
          src="https://github.com/GraduateCampus/CanvasEditor/blob/main/src/components/images/Learniac.png?raw=true"
        />
      </div>
    </div>
  );
