...
import { l2ContactBoxes } from "../../services/atoms";
...
function Contacts() {
  ...
  return (
    <div className="dropdown-form">
      <button className="btn-chapter" onClick={addBox}>
        Karte hinzufügen
      </button>
      {boxes.map((box, index) => (
        <div key={box.id}>
          <div className="chapter-wrapper">
            <button
              ...
              onClick={() => toggleSelectedBox(box.id)}
            >
              ...
              {selectedBoxId === box.id ? (
                <>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      update(box.id, "description", e.target.value)
                    }
                ...
                <div className="btn-new-chapter" style={{ cursor: "default" }}>
                  Kontakt {index + 1}
                </div>
              )}
            </div>
