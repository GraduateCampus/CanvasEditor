  ...
  return (
    <nav className="editor-navbar">
      <ul>
        <li>
          <button
            className={`editor-button ${showPointWelcome ? "active" : ""}`}
            onClick={() => setShowPointWelcome(!showPointWelcome)}
          >
            Willkommen im Kurs
          </button>
        ...
        <li>
          <button
            className={`editor-button ${showPointCourse ? "active" : ""}`}
            onClick={() => setShowPointCourse(!showPointCourse)}
          >
            Kursablauf
          </button>
        ...
        <li>
          <button
            className={`editor-button ${showPointUnits ? "active" : ""}`}
            onClick={() => setShowPointUnits(!showPointUnits)}
          >
            Deine E-Learning Einheiten
          </button>
          {showPointUnits && <PointUnits />}
        </li>
        <li>
          <button
            className={`editor-button ${showPointLearning ? "active" : ""}`}
            onClick={() => setShowPointLearning(!showPointLearning)}
          >
            Mit E-Learnings lernen
          </button>
          {showPointLearning && <PointLearning />}
        </li>
        <li>
          <button
            className={`editor-button ${showPointInfo ? "active" : ""}`}
        ...
        <li>
          <button
            className={`editor-button ${showContacts ? "active" : ""}`}
